...
# --------------- main turning logic ---------------
async def p_turn__heading_(desired, left_motor, right_motor, prime_hub, c_parameter):
...
async def p_turn__incremental_(turn_amount, left_motor, right_motor, prime_hub, c_parameter):
    ...
    await p_turn__heading_(target_heading, left_motor, right_motor, prime_hub, c_turn_parameter)
